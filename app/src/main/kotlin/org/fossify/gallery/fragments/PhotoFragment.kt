            ...
            activity?.runOnUiThread {
                ...
                if (showBlur) {
                    ...
                    Glide.with(ctx)
                        ...
                        .thumbnail(0.2f)
                        .apply(RequestOptions().transform(BlurTransformation(60, 3)))
                        .into(binding.photoBlurBackground)
                } else {
                    binding.photoBlurBackground.visibility = View.GONE
                    Glide.with(requireContext()).clear(binding.photoBlurBackground)
                }
            }
        }
    }
