...
open class VideoPlayerActivity : BaseViewerActivity(), SeekBar.OnSeekBarChangeListener,
    ...
    private fun initExoPlayer() {
        ...
        mExoPlayer = ExoPlayer.Builder(this).setSeekParameters(com.google.android.exoplayer2.SeekParameters.CLOSEST_SYNC).setSeekParameters(com.google.android.exoplayer2.SeekParameters.CLOSEST_SYNC).setSeekParameters(com.google.android.exoplayer2.SeekParameters.CLOSEST_SYNC).setSeekParameters(com.google.android.exoplayer2.SeekParameters.CLOSEST_SYNC).setSeekParameters(com.google.android.exoplayer2.SeekParameters.CLOSEST_SYNC).setSeekParameters(com.google.android.exoplayer2.SeekParameters.CLOSEST_SYNC)
